...
#
Decay B0
1.00      MyD*- pi+               PHOTOS SVS; #[Reconstructed PDG2011]
Enddecay
#
# Tag side
#
...
probefilter = cms.EDFilter(
    ...
    DaughterIDs        = cms.untracked.vint32(-413, 211),
    MinPt              = cms.untracked.vdouble(-1., 6.),
    MinEta             = cms.untracked.vdouble(-9999999., -2.3),
    MaxEta             = cms.untracked.vdouble( 9999999.,  2.3)
)
