...
# 0.0045   myD_1-   Mytau+  nu_mu       PHOTOS   ISGW2;
# 0.0040   myD'_1-   Mytau+  nu_mu      PHOTOS   ISGW2;
# 0.0010   myD_2*-   Mytau+  nu_mu      PHOTOS   ISGW2; # 0.0033*0.209/0.6667
# From PDG, including D** -> D* decay
0.0030   myD_1-   Mytau+  nu_mu       PHOTOS   ISGW2;
0.0027   myD'_1-   Mytau+  nu_mu      PHOTOS   ISGW2;
0.0010   myD_2*-   Mytau+  nu_mu      PHOTOS   ISGW2;
Enddecay
#
End
"""
