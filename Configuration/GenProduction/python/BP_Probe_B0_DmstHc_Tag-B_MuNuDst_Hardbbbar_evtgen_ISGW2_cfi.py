...
generator = cms.EDFilter("Pythia8GeneratorFilter",
    ...
    ExternalDecays = cms.PSet(
        EvtGen130 = cms.untracked.PSet(
            ...
            operates_on_particles = cms.vint32(511, 521, -521),
...
#
Alias      MyTagD0   D0
Alias      MyTaganti-D0   anti-D0
ChargeConj MyTagD0   MyTaganti-D0
#
Decay MyTagD0
...
CDecay MyTaganti-D0
Decay B+
1.000     MyTaganti-D0 mu+ nu_mu         PHOTOS  ISGW2;
Enddecay
#
Decay B-
1.000     MyTagD0 mu- anti-nu_mu         PHOTOS  ISGW2;
Enddecay
#
End
"""
...
tagfilter = cms.EDFilter(
    ...
    DaughterIDs        = cms.untracked.vint32(-421, -13, 14),
...
ProductionFilterSequence = cms.Sequence(generator + tagfilter + B0filter + mufilter + DstFilter + antiD0Filter)
