...
Decay MyB0
0.00247     MyD*-         MyLepD0         K+                        PHSP;
0.00124     MyD*-         MyLepD0         K*+                       PHSP;
0.01060     MyD*-         MyLepD*0        K+                        PHSP;
0.00530     MyD*-         MyLepD*0        K*+                       PHSP;

0.00540     MyD*-         MyLepD*+        K0                        PHSP;
0.00540     MyLepD*-      MyD*+           K0                        PHSP;

0.00270     MyD*-         MyLepD*+        K*0                       PHSP;
0.00270     MyLepD*-      MyD*+           K*0                       PHSP;

0.00054     MyD*-         MyLepD*+                                  SVV_HELAMP 0.56 0.0 0.96 0.0 0.47 0.0;
0.00054     MyLepD*-      MyD*+                                     SVV_HELAMP 0.56 0.0 0.96 0.0 0.47 0.0;
