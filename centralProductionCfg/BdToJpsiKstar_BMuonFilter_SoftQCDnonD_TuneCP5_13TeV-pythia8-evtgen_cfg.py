...
# with command line options: Configuration/GenProduction/python/BPH-RunIIFall18GS-00125-fragment.py --fileout file:BPH-RunIIFall18GS-00125.root --mc --eventcontent RAWSIM --datatier GEN-SIM --conditions 102X_upgrade2018_realistic_v11 --beamspot Realistic25ns13TeVEarly2018Collision --step GEN,SIM --nThreads 2 --geometry DB:Extended --era Run2_2018 --python_filename /afs/cern.ch/cms/PPD/PdmV/work/McM/submit/BPH-RunIIFall18GS-00125/BPH-RunIIFall18GS-00125_1_cfg.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 6093
...
process.maxEvents = cms.untracked.PSet(
    input = cms.untracked.int32(6093)
)
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/BPH-RunIIFall18GS-00125-fragment.py nevts:6093'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:BPH-RunIIFall18GS-00125.root'),
